...
function getStats(): void {
    ...
    $stats['total_jobs']     = $db->query('SELECT COUNT(*) FROM jobs WHERE is_active=1')->fetchColumn();
    $stats['total_users']    = $db->query('SELECT COUNT(*) FROM users WHERE role="seeker"')->fetchColumn();
